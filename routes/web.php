...
Route::controller(AdministradorController::class)->group(function(){
    ...
    Route::get('/crear_admin_resguadropdf_linea/{id}/{person_id}', 'crear_resguardopdf_linea')
        ->middleware('auth.admin')
        ->name('resguardo.crear_admin_resguardopdf_linea');
...
Route::controller(CoadminController::class)->group(function(){
    ...
    Route::get('/crear_coadmin_resguadropdf_linea/{id}/{person_id}', 'crear_resguardopdf_linea')
        ->middleware('auth.coadmin')
        ->name('resguardo.crear_coadmin_resguardopdf_linea');
