...
var echartsBasicBarChartInit = function echartsBasicBarChartInit() {
  ...
  if ($barChartEl) {
    ...
    var months = ['Enero', 'Febrero', 'Marzo', 'Abril', 'Mayo', 'Junio', 'Julio', 'Agosto', 'September', 'October', 'November', 'December'];
    var data = [5000, 3000, 4000, 1000, 1086, 1236, 1219, 1330, 1367, 1416, 1297, 1204];
