...
<body>
  <header>
    ...
    <h1>{{$empresa}}</h1>
    <h2>Resguardo</h2>
    <h3 style="color: blue">Rol de Administrador</h3>
  </header>
    ...
    <table>
        ...
        @foreach ($articulos as $articulo)
            <tr>
                ...
                <td style="text-align: center">{{ $depto[$n-1][0]->group }}</td>
  ...
  <div class="tarjeta text-center">    
    <img src="{{$articulo->firma}}" width="100" height="100"/>
  </div>

  <div class="nota">
    ** Nota: <br>
    1) Documento de referencia, este enlista los artículos asignados a la persona mencionada hasta la fecha en la que el documento fue emitido. <br>
    2) Este listado puede variar si se sufren cambios en los artículos asignados ya sea por reparación, daño o adición. <br>
    3) Consta que para cada cambio que surge en el sistema se registra la firma del personal mencionado y este queda guardado en sistema para cualquier duda y/o aclaración.
  </div>
</body>
</html>