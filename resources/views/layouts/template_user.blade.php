    ...
    <li class="nav-item">
        ...
        <div id="collapseOperacion" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="{{ route('registros.user') }}">Remisiones</a>
                <a class="collapse-item" href="{{ route('user.historial') }}">Historial</a>
            </div>
        </div>
    </li>
                    ...
                    <li class="nav-item dropdown no-arrow">
                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                            ...
                            <img class="img-profile rounded-circle"
                                src="{{ $ruta }}../resources/img/undraw_profile.svg">
                            @endif
                        </a>
                        ...
                        <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                            ...
                            @if (auth()->user()->auten == 1)
                                <a class="dropdown-item" href="{{ route('usuarios.pass_user', auth()->user()->id) }}">
