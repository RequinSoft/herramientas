    ...
    <li class="nav-item">
        ...
        <div id="collapseOperacion" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="{{ route('registros.auth') }}">Remisiones</a>
                <a class="collapse-item" href="{{ route('auth.autorizar') }}">Autorizar</a>
                <a class="collapse-item" href="{{ route('auth.historial') }}">Historial</a>
            </div>
        </div>
    </li>
