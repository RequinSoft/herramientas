              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse" id="herramientas">
                    ...
                    <li class="nav-item"><a class="nav-link" href="{{ route('resguardo.buscar') }}" data-bs-toggle="" aria-expanded="false">
                        <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Buscar</span>
                        </div>
                      </a>
                      <!-- more inner pages-->
                    </li>
    ...
    <div class="offcanvas offcanvas-end settings-panel border-0" id="settings-offcanvas" tabindex="-1" aria-labelledby="settings-offcanvas">
      ...
      <div class="offcanvas-body scrollbar-overlay px-card" id="themeController">
        ...
        <div class="d-flex justify-content-between">
          <div class="d-flex align-items-start"><img class="me-2" src="{{ $ruta }}../resources/assets/img/icons/left-arrow-from-left.svg" width="20" alt="" />
            <div class="flex-1">
        ...
        <hr />
        <div class="d-flex justify-content-between">
          <div class="d-flex align-items-start"><img class="me-2" src="{{ $ruta }}../resources/assets/img/icons/arrows-h.svg" width="20" alt="" />
            <div class="flex-1">
