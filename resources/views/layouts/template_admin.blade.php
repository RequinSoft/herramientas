...
<html lang="en-US" dir="ltr">
  ...
  <body>
    @php
        $imagen = $ruta."../storage/app/avatars/".auth()->user()->name.".jpg";
    @endphp
          ...
          <div class="collapse navbar-collapse" id="navbarVerticalCollapse">
            <div class="navbar-vertical-content scrollbar">
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  <!-- parent pages-->
                  <a class="nav-link" href="{{ route('admin.index') }}" role="button" data-bs-toggle="" aria-expanded="false">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse" id="usuarios">
                    <li class="nav-item"><a class="nav-link" href="{{ route('admin.usuarios') }}" data-bs-toggle="" aria-expanded="false">
                        <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Usuarios</span>
                        </div>
                      </a>
                      <!-- more inner pages-->
                    </li>
                    <li class="nav-item"><a class="nav-link" href="{{ route('admin.personal') }}" data-bs-toggle="" aria-expanded="false">
                        <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Personal</span>
                        </div>
                      </a>
                      <!-- more inner pages-->
                    </li>
                  ...
                  <!-- parent pages-->
                  <a class="nav-link" href="{{ route('admin.articulos') }}" role="button" data-bs-toggle="" aria-expanded="false">
                  ...
                  <!-- parent pages-->
                  <a class="nav-link dropdown-indicator" href="#grupos" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="grupos">
                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span class="fas fa-layer-group"></span></span><span class="nav-link-text ps-1">Grupos</span>
                    </div>
                  </a>
                  <ul class="nav collapse" id="grupos">
                    <li class="nav-item"><a class="nav-link" href="{{ route('admin.categorias') }}" data-bs-toggle="" aria-expanded="false">
                        <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Categorías</span>
                        </div>
                      </a>
                      <!-- more inner pages-->
                    </li>
                    <li class="nav-item"><a class="nav-link" href="{{ route('admin.grupos') }}" data-bs-toggle="" aria-expanded="false">
                        <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Departamentos</span>
                        </div>
                      </a>
                      <!-- more inner pages-->
                    </li>
                ...
                <li class="nav-item">
                  <!-- label-->
                  <div class="row navbar-vertical-label-wrapper mt-3 mb-2">
                    <div class="col-auto navbar-vertical-label">Operación
                    </div>
                    <div class="col ps-0">
                      <hr class="mb-0 navbar-vertical-divider" />
                    </div>
                  ...
                  <ul class="nav collapse" id="herramientas">
                    <li class="nav-item"><a class="nav-link" href="{{ route('resguardo.nuevo') }}" data-bs-toggle="" aria-expanded="false">
                  ...
                  <ul class="nav collapse" id="buscar">
                    <li class="nav-item"><a class="nav-link" href="{{ route('resguardo.buscar_persona') }}" data-bs-toggle="" aria-expanded="false">
                        <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Persona</span>
                        </div>
                      </a>
                      <!-- more inner pages-->
                    </li>
                    <li class="nav-item"><a class="nav-link" href="{{ route('resguardo.buscar_articulo') }}" data-bs-toggle="" aria-expanded="false">
                ...
                <li class="nav-item">
                  <!-- label-->
                  <div class="row navbar-vertical-label-wrapper mt-3 mb-2">
                    <div class="col-auto navbar-vertical-label">Historial
                    </div>
                    <div class="col ps-0">
                      <hr class="mb-0 navbar-vertical-divider" />
                    </div>
        ...
        <div class="content">
          ...
          <nav class="navbar navbar-light navbar-glass navbar-top navbar-expand">
            ...
            <a class="navbar-brand me-1 me-sm-3" >
              <div class="d-flex align-items-center"><img class="me-2" src="{{ $ruta }}../resources/assets/img/icons/spot-illustrations/toolguardian-blue.png" alt="" width="40" /><span class="font-sans-serif">TG</span>
              </div>
            </a>
              ...
              <li class="nav-item dropdown"><a class="nav-link pe-0 ps-2" id="navbarDropdownUser" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="dropdown-menu dropdown-caret dropdown-caret dropdown-menu-end py-0" aria-labelledby="navbarDropdownUser">
                  <div class="bg-white dark__bg-1000 rounded-2 py-2">
                    ...
                    <a class="dropdown-item" href="{{ route('home.destroy') }}">Logout</a>
                  </div>
                </div>
              </li>
            </ul>
    ...
    <div class="offcanvas offcanvas-end settings-panel border-0" id="settings-offcanvas" tabindex="-1" aria-labelledby="settings-offcanvas">
      <div class="offcanvas-header settings-panel-header bg-shape">
        <div class="z-index-1 py-1 light">
          <div class="d-flex justify-content-between align-items-center mb-1">
            <h5 class="text-white mb-0 me-2"><span class="fas fa-palette me-2 fs-0"></span>Ajustes</h5>
          ...
          <p class="mb-0 fs--1 text-white opacity-75"> Escoge tu estilo</p>
        </div>
        <button class="btn-close btn-close-white z-index-1 mt-0" type="button" data-bs-dismiss="offcanvas" aria-label="Close"></button>
      </div>
      <div class="offcanvas-body scrollbar-overlay px-card" id="themeController">
        <h5 class="fs-0">Colores</h5>
        <div class="btn-group d-block w-100 btn-group-navbar-style">
          <div class="row gx-2">
            <div class="col-6">
              <input class="btn-check" id="themeSwitcherLight" name="theme-color" type="radio" value="light" data-theme-control="theme" />
              <label class="btn d-inline-block btn-navbar-style fs--1" for="themeSwitcherLight"> <span class="hover-overlay mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0" src="{{ $ruta }}../resources/assets/img/generic/falcon-mode-default.jpg" alt=""/></span><span class="label-text">Light</span></label>
            </div>
            <div class="col-6">
              <input class="btn-check" id="themeSwitcherDark" name="theme-color" type="radio" value="dark" data-theme-control="theme" />
              <label class="btn d-inline-block btn-navbar-style fs--1" for="themeSwitcherDark"> <span class="hover-overlay mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0" src="{{ $ruta }}../resources/assets/img/generic/falcon-mode-dark.jpg" alt=""/></span><span class="label-text"> Dark</span></label>
            </div>
          </div>
        </div>
        <hr />
        <h5 class="fs-0 d-flex align-items-center">Menú Vertical</h5>
        <p class="fs--1 mb-0">Cambia estilos del menú </p>
        <div class="btn-group d-block w-100 btn-group-navbar-style">
          <div class="row gx-2">
            <div class="col-6">
              <input class="btn-check" id="navbar-style-transparent" type="radio" name="navbarStyle" value="transparent" data-theme-control="navbarStyle" />
              <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-transparent"> <img class="img-fluid img-prototype" src="{{ $ruta }}../resources/assets/img/generic/default.png" alt="" /><span class="label-text"> Transparent</span></label>
            </div>
            <div class="col-6">
              <input class="btn-check" id="navbar-style-inverted" type="radio" name="navbarStyle" value="inverted" data-theme-control="navbarStyle" />
              <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-inverted"> <img class="img-fluid img-prototype" src="{{ $ruta }}../resources/assets/img/generic/inverted.png" alt="" /><span class="label-text"> Inverted</span></label>
            </div>
            <div class="col-6">
              <input class="btn-check" id="navbar-style-card" type="radio" name="navbarStyle" value="card" data-theme-control="navbarStyle" />
              <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-card"> <img class="img-fluid img-prototype" src="{{ $ruta }}../resources/assets/img/generic/card.png" alt="" /><span class="label-text"> Card</span></label>
            </div>
            <div class="col-6">
              <input class="btn-check" id="navbar-style-vibrant" type="radio" name="navbarStyle" value="vibrant" data-theme-control="navbarStyle" />
              <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-vibrant"> <img class="img-fluid img-prototype" src="{{ $ruta }}../resources/assets/img/generic/vibrant.png" alt="" /><span class="label-text"> Vibrant</span></label>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="card-body d-flex align-items-center py-md-2 px-2 py-1">
        ...
        </div><small class="text-uppercase text-primary fw-bold bg-soft-primary py-2 pe-2 ps-1 rounded-end">Ajustes</small>
      </div>
    </a>
