    ...
    <div class="table-responsive scrollbar">
      <table class="table table-bordered table-striped fs--2 mb-0" id="tabla_articulos">
        <div class="search-box" data-list='{"valueNames":["ns"]}'>
            <input class="form-control search-input search" type="search" placeholder="Buscar N/S..." aria-label="Search" data-column="7"/>
        ...
        <thead class="bg-500 text-900">
          <tr>
            ...
            <th class="sort" data-sort="estatus">Asignado a</th>
        ...
        <tbody class="list">
            ...
            <tr>
                ...
                <td class="persona">{{ $row->lineas[0]->personal->nombre ?? '' }}</td>
