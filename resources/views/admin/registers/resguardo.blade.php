      ...
      <table class="table table-bordered table-striped fs--2 mb-0">
        ...
        <tbody class="list">
            ...
            <tr>
                ...
                <td class="text-center">
                    <a href="{{ route('resguardo.editarlinea', $articulo->id) }}" class="btn  btn-sm" title="Reporte"><i class="text-500 fas fa-edit"></i></a>
                    <a href="{{ route('resguardo.crear_admin_resguardopdf_linea', [$articulo->id, $person->id]) }}" target="_blank" class="btn  btn-sm" title="Imprimir"><i class="text-500 far fa-file-pdf"></i></a>
                </td>
            </tr>
            @php
                $n++;
...
<!-- /.container-fluid 
<img class="rounded-circle" src="{{$ruta.$articulo->firma}}">
-->
