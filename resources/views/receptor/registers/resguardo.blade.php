...
<div id="tableExample2" data-list='{"valueNames":["articulo", "precio_actual", "creado", "estado"]}'>
    ...
    <div class="table-responsive scrollbar">
      <table class="table table-bordered table-striped fs--2 mb-0">
        ...
        <tbody class="list">
            ...
            <tr>
                ...
                <td class="text-center"><a href="{{ route('resguardo.receptor_editarlinea', $articulo->id) }}" class="btn  btn-sm" title="Reporte"><i class="text-500 fas fa-edit"></i></a></td>
            </tr>
            @php
                $n++;
            @endphp
      ...
      <div class="col-sm-12 mb-3">
        <center>
        <a href="{{route('resguardo.receptor_buscar_persona')}}" class="btn btn-primary btn-user btn-block">
            Regresar
        </a> 
        </center>                 
      </div>
