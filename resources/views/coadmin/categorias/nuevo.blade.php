...
@section('title', 'Nuevas Categorías')
...
<div class="card mb-3">
    ...
    <div class="card-body bg-light">
        <form action="{{route('coadmin_categorias.crear')}}" method="POST">
        @csrf
            <div class="row gx-2">  
                ...
                <div class="col-sm-3 mb-3">
                    ...
                    <input class="form-control" id="depreciacion" name="depreciacion" type="number" value="{{ old('depreciacion') }}" />
                </div>    
