...
<div id="tableExample2" data-list='{"valueNames":["articulo", "precio_actual", "creado", "estado"]}'>
    ...
    <form action="actualizar_coadmin_asignado_articulo" method="POST" enctype="multipart/form-data">
        @csrf
    <div class="table-responsive scrollbar">
      ...
      <div class="col-sm-12 mb-3">
        <center>
            <a href="resguardo_coadmin_buscar_articulo"  class="btn btn-warning btn-user btn-block">
                Regresar
            </a>
