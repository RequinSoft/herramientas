...
<div class="d-flex bg-200 mb-3 flex-row-reverse">
    <a href="{{ route('resguardo.coadmin_nuevo') }}" class="btn btn-primary btn-sm" title="Añadir Resguardo"><i class="text-100 fas fa-plus-circle"></i></a>
</div>
<div id="tableExample2" data-list='{"valueNames":["nombre","puesto", "grupo", "custom"],"page":25,"pagination":true}'>
    <div class="table-responsive scrollbar">
      <table class="table table-bordered table-striped fs--2 mb-0">
        <div class="search-box" data-list='{"valueNames":["nombre"]}'>
        ...
        <tbody class="list">
            ...
            <tr>
                ...
                <td class="text-center ">
                    <a href="{{ route('resguardo.coadmin_editar', $row[0]->id) }}" class="btn  btn-sm" title="Editar"><i class="text-500 fas fa-edit"></i></a>
                    <a href="{{ route('resguardo.crear_coadmin_resguardopdf', $row[0]->id) }}" target="_blank" class="btn  btn-sm" title="PDF"><i class="text-500 far fa-file-pdf"></i></a>
                </td>
            </tr>
            @php
                $n++;
