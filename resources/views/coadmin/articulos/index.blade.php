...
<div class="d-flex bg-200 mb-3 flex-row-reverse">
    <a href="{{ route('articulos.coadmin_nuevo') }}" class="btn btn-primary btn-sm" title="Añadir Articulos"><i class="text-100 fas fa-plus-circle"></i></a>
</div>
    ...
    <div class="table-responsive scrollbar">
      <table class="table table-bordered table-striped fs--2 mb-0">
        <div class="search-box" data-list='{"valueNames":["ns"]}'>
            <input class="form-control search-input search" type="search" placeholder="Search N/S..." aria-label="Search" data-column="7"/>
        ...
        <tbody class="list">
            ...
            <tr>
                ...
                <td class="text-center">
                    <a href="{{ route('articulos.coadmin_editar', $row->id) }}" class="btn btn-sm" title="Editar"><i class="text-500 fas fa-edit"></i></a>
                    &nbsp;
                    <a href="{{ route('articulos.coadmin_inactivar', $row->id) }}" class="btn btn-sm" title="Inhabilitar"><i class="text-500 fas fa-trash-alt"></i></a>
                </td>
            </tr>
            @php
                $n++;
